...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    $name_surname = $_POST["fullname"];
    $mail = $_POST["email"];
    $phone = isset($_POST["phone"]) ? intval($_POST["phone"]) : null;
    $title = $_POST["title"];
    $messages = $_POST["message"];

    if($message->createMessage($name_surname,$mail,$phone,$title,$messages)){
        ...
        <div class="container">
            ...
            <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                ...
                <p class="text-secondary mb-5 text-center">
                    Bizimle iletişime geçmekten çekinmeyin. Sizin fikirleriniz bizim planlarımız demektir.
                </p>
    ...
    <div class="container">
        ...
        <div class="col-12 col-lg-9">
            ...
            <form action="" method="post">
                ...
                <div class="col-12">
                    <label for="title" class="form-label">Konu <span class="text-danger">*</span></label>
