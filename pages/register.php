    ...
    <div class="container">
        ...
        <div class="row g-0">
            ...
            <div class="d-flex align-items-center justify-content-center h-100">
                ...
                <h2 class="h1 mb-4">Emre Arslan</h2>
                <p class="lead m-0">Üye ol ve birbirinden ilginç yazılardan anında haberdar ol.</p>
                </div>
            </div>
            </div>
            ...
            <div class="card-body p-3 p-md-4 p-xl-5">
                ...
                <div class="row gy-3 gy-md-4 overflow-hidden">
                    ...
                    <input type="email" class="form-control" name="email" id="email" placeholder="ornek@ornek.com" required>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                    <div class="d-grid">
                        <button class="btn bsb-btn-xl btn-outline-success" type="submit">Kayıt Ol</button>
                    </div>
                    </div>
                </div>
                </form>
                ...
                <div class="col-12">
                    ...
                    <a href="#!" class="link-secondary text-decoration-none">Giriş Yap.</a>
                ...
                <div class="row">
                <div class="col-12">
                    <p class="mt-5 mb-4">Ya da sosyal medya hesabınla giriş yap</p>
